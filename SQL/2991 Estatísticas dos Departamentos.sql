SELECT
	...
	ROUND(valor,2)((AVG(tsalario.salario - tdescontos.descontos)), '99999.99') AS "Media Salarial",
	ROUND(valor,2)((MAX(tsalario.salario - tdescontos.descontos)), '99999.99') AS "Maior Salario",
	(CASE
